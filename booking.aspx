<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="booking.aspx.cs" Inherits="Assignment7.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="container">
        <div class="left">
            ...
            <button class="btn-learn-more submit" id="submit" type="button">
                <span>Submit</span>
            </button>
        </div>
